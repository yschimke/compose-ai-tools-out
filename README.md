# Wear Compose Material 3 — design artifacts
...
**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/wear-m3/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/wear-m3/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/wear-m3/)**

The same rendered components, served live by `compose-preview serve --catalogs wear-m3` —
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/wear-m3/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/wear-m3/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/wear-m3/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
